  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        {/* Novelas en Transmisión - Sección Independiente */}
        {adminState.novels && adminState.novels.filter(novel => novel.estado === 'transmision').length > 0 && (
          <section className="mb-12">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6">
              {adminState.novels.filter(novel => novel.estado === 'transmision').slice(0, 10).map((novel) => (
                <Link
                  to={`/novel/${novel.id}`}
        ...
        {/* Novelas Finalizadas - Sección Independiente */}
        {adminState.novels && adminState.novels.filter(novel => novel.estado === 'finalizada').length > 0 && (
          <section className="mb-12">
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-2xl font-bold text-gray-900 flex items-center">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6">
              {adminState.novels.filter(novel => novel.estado === 'finalizada').slice(0, 10).map((novel) => (
                <Link
                  to={`/novel/${novel.id}`}
